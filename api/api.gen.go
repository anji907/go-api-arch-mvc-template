...
// UpdatedAlbumByIdJSONRequestBody defines body for UpdatedAlbumById for application/json ContentType.
type UpdatedAlbumByIdJSONRequestBody = AlbumUpdateRequest
...
type ClientInterface interface {
	...
	// UpdatedAlbumByIdWithBody request with any body
	UpdatedAlbumByIdWithBody(ctx context.Context, id int, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpdatedAlbumById(ctx context.Context, id int, body UpdatedAlbumByIdJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) UpdatedAlbumByIdWithBody(ctx context.Context, id int, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdatedAlbumByIdRequestWithBody(c.Server, id, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdatedAlbumById(ctx context.Context, id int, body UpdatedAlbumByIdJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdatedAlbumByIdRequest(c.Server, id, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewUpdatedAlbumByIdRequest calls the generic UpdatedAlbumById builder with application/json body
func NewUpdatedAlbumByIdRequest(server string, id int, body UpdatedAlbumByIdJSONRequestBody) (*http.Request, error) {
	...
	return NewUpdatedAlbumByIdRequestWithBody(server, id, "application/json", bodyReader)
}

// NewUpdatedAlbumByIdRequestWithBody generates requests for UpdatedAlbumById with any type of body
func NewUpdatedAlbumByIdRequestWithBody(server string, id int, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// UpdatedAlbumByIdWithBodyWithResponse request with any body
	UpdatedAlbumByIdWithBodyWithResponse(ctx context.Context, id int, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdatedAlbumByIdResponse, error)

	UpdatedAlbumByIdWithResponse(ctx context.Context, id int, body UpdatedAlbumByIdJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdatedAlbumByIdResponse, error)
...
type UpdatedAlbumByIdResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *AlbumResponse
	JSON404      *ErrorResponse
...
// Status returns HTTPResponse.Status
func (r UpdatedAlbumByIdResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r UpdatedAlbumByIdResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// UpdatedAlbumByIdWithBodyWithResponse request with arbitrary body returning *UpdatedAlbumByIdResponse
func (c *ClientWithResponses) UpdatedAlbumByIdWithBodyWithResponse(ctx context.Context, id int, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdatedAlbumByIdResponse, error) {
	rsp, err := c.UpdatedAlbumByIdWithBody(ctx, id, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdatedAlbumByIdResponse(rsp)
}

func (c *ClientWithResponses) UpdatedAlbumByIdWithResponse(ctx context.Context, id int, body UpdatedAlbumByIdJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdatedAlbumByIdResponse, error) {
	rsp, err := c.UpdatedAlbumById(ctx, id, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdatedAlbumByIdResponse(rsp)
...
// ParseUpdatedAlbumByIdResponse parses an HTTP response from a UpdatedAlbumByIdWithResponse call
func ParseUpdatedAlbumByIdResponse(rsp *http.Response) (*UpdatedAlbumByIdResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &UpdatedAlbumByIdResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
type ServerInterface interface {
	...
	// (PATCH /album/{id})
	UpdatedAlbumById(c *gin.Context, id int)
	// Create a new album
	// (POST /albums)
...
// UpdatedAlbumById operation middleware
func (siw *ServerInterfaceWrapper) UpdatedAlbumById(c *gin.Context) {
	...
	siw.Handler.UpdatedAlbumById(c, id)
}
...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.PATCH(options.BaseURL+"/album/:id", wrapper.UpdatedAlbumById)
...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/+RWXU/bMBT9K9HdHqMmBaShvEEZqJrEpmp7QjyY+LY1Smxj3zBVVf77ZDtVa1JKmbru",
	"AfUlte7HueecXGcJpaq1kijJQrEEW86xZv7xonpo6pFBRjjBpwYtuVNtlEZDAn1MyQhnyizc82eDUyjg",
	"U7aumHXlstEqrk3BYIXM4hUjfCttshHapkCCKp9DC41QgCUj5AxaX/SpEQY5FHddWLoGF/e8T1f56uER",
	"S3KV/awTtFpJi/0xmZTiGY1lb096sRHapn9FkOAbMwpJOENzFOIEh3Qbe5vj78nlL80P7ZsdQ/QxxIL1",
	"uRxtAIihvca+ZLXvjrKpHVlTpRxddWNFCSlYrQzZDUJe4diX2UbbV2OUed2CNVrLZnuIuArc1mMSO2iq",
	"TM0ICnBaQR+586KcKt8zkA83Krn4MU5+Yq2rkORoFkpCAcNBPshdG6VRMi2ggNNBPjiFFDSjuR8jY84d",
	"2VLw1v3lWGHA4mZlJJQccyjgyp97J10uxtxXMKxGQmOhuFuCcA1dVVgpE9y7ZoJMg2m3z7Yp2t676EC3",
	"h3aSnwVItjRCU5jpViUjJQml5+8sz717uxO3GbSuROmBZ4/Wpew2dKyyYzjud8l4snprfMOzPRquh3xP",
	"617vW0XJtWok97hsU9f+9enESFjitUseFsn4yoGbIfWVu0E6tmz5wSiKr4EtFH3/9nFtcC0kf2kBzaic",
	"900Qtj8/ghE8RZeKLw7rgfj6auMd65C1/9OFHb0f14qBgJcbqU2768UropXdsp7C96xnGP6hf+LP5r38",
	"MzyefwK6d/jnQHJGVooEDYgSlkj8HUQN+RbN82plNKaCAuZEusiyfOB/xXl+nmdMi+x5CG36IqhSJavm",
	"ytLusOHJF19tGIfdt38CAAD//2HiPc4dDQAA",
}
